...
})({"4fosZ":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "3ca93f9a49cd543c";
"use strict";
...
},{}],"20lyk":[function(require,module,exports) {
var _bootstrap = require("bootstrap");
var _firebaseJs = require("./firebase.js");
const flashcardsDatabase = new (0, _firebaseJs.Database)();
async function loadUsers() {
    try {
        for (const [key, value] of Object.entries(await flashcardsDatabase.getEntries("users")))$("#selectUser").append("<option value='" + key + "'>" + key + "</option>");
    } catch (e) {
        console.log(e);
    }
}
...
function updateFlashcards(flashcards) {
    $("#flashcards").empty();
    for (const [key, value] of Object.entries(flashcards))$("#flashcards").append("<tr class='flashcard'><td>" + value.ask + "</td>" + "<td>" + value.answer + "</td>" + "<td>" + "<button class='btn remove-btn btn-danger' value='" + key + "'>Remove</button>" + "</td>" + "</tr>");
}
// $(".remove-btn").click((e) => {
...
$("#add_flashcard").submit((e)=>{
    try {
        let flashcardToSend = new (0, _firebaseJs.Flashcard)($("#question").val(), $("#answer").val(), $("#selectUser").val(), $("#selectSet").val());
...
},{"bootstrap":"h36JB","./firebase.js":"iBQ7U"}],"h36JB":[function(require,module,exports) {
/*!
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iBQ7U":[function(require,module,exports) {
// Import the functions you need from the SDKs you need
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Flashcard", ()=>Flashcard);
...
class Database {
    ...
    async addCards(userID, card) {
        ...
        const newPostFlashcards = (0, _database.push)((0, _database.ref)(db, "flashcards"));
        const newPostFlashcardsToUser = (0, _database.push)((0, _database.ref)(db, "users/" + userID + "/flashcards"));
        ...
        try {
            ...
            await (0, _database.set)(newPostFlashcards, PostCard);
            await (0, _database.set)(newPostFlashcardsToUser, PostCard);
        } catch (e) {
            console.log(e);
        }
    }
    async addUser(name) {
        ...
        try {
            await (0, _database.set)(newPostUsers, name);
        } catch (e) {
            console.log(e);
        }
    }
    ...
    async getCards(userID) {
        const userRef = (0, _database.ref)(db, "users/" + userID + "/flashcards");
        await this.getEntries(userRef);
    }
    async getEntries(location) {
        const entriesRef = (0, _database.ref)(db, location);
        try {
            let response = await (0, _database.get)(entriesRef);
    ...
    async attachListener(location, callback) {
        //return snapshot
        (0, _database.onValue)((0, _database.ref)(db, location), (snapshot)=>{
...
},{"6b38617303e2f7b9":"d5jf4","@firebase/app":"3AcPV","@firebase/component":"bi1VB","@firebase/util":"ePiK6","@firebase/logger":"fZmft","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4fosZ","20lyk"], "20lyk", "parcelRequire170a")

//# sourceMappingURL=index.49cd543c.js.map
