...
})({"gZBxB":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "59ebdd7abecd61c5";
"use strict";
...
},{}],"gv6jb":[function(require,module,exports) {
...
class database {
    ...
    addCards(userID, card) {
        const userRef = (0, _database.ref)(db, "users/" + userID);
        const flashcardsRef = (0, _database.child)(userRef, "flashcards");
        const newPostFlashcards = (0, _database.push)(flashcardsRef);
        console.log(flashcardsRef);
        (0, _database.set)(newPostFlashcards, [
            card.ask,
            card.answer
        ], (error)=>{
    ...
    // }
    getCards() {
        const userRef = (0, _database.ref)(db, "users/ewa");
        const flashcardsRef = (0, _database.child)(userRef, "flashcards");
        (0, _database.get)(flashcardsRef).then((snapshot)=>{
            if (snapshot.exists()) //print in console all cards
...
let card1 = new Flashcard("question1", "3");
// db1.addCards("ewa", card1);
db1.getCards();

},{"firebase/app":"aM3Fo","firebase/database":"SJ4UY","firebase/analytics":"bSFRu"}],"aM3Fo":[function(require,module,exports) {
...
},{"6b38617303e2f7b9":"d5jf4","@firebase/app":"3AcPV","@firebase/component":"bi1VB","@firebase/util":"ePiK6","@firebase/logger":"fZmft","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bSFRu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _analytics = require("@firebase/analytics");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gZBxB","gv6jb"], "gv6jb", "parcelRequire170a")

//# sourceMappingURL=index.becd61c5.js.map
