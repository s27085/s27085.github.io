...
})({"5wWht":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "dbe6166ce627dc85";
"use strict";
...
},{}],"iBQ7U":[function(require,module,exports) {
...
class Database {
    ...
    async addUser(name) {
        const usersRef = (0, _database.ref)(db, "users/" + name);
    ...
    async removeCard(userID, cardID) {
        const userRef = (0, _database.ref)(db, "users/" + userID + "/flashcards/" + cardID);
        const flashcardRef = (0, _database.ref)(db, "flashcards/" + cardID);
        try {
            await (0, _database.set)(userRef, null);
            await (0, _database.set)(flashcardRef, null);
        } catch (e) {
            console.log(e);
        }
    }
...
},{"6b38617303e2f7b9":"d5jf4","@firebase/app":"3AcPV","@firebase/component":"bi1VB","@firebase/util":"ePiK6","@firebase/logger":"fZmft","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5wWht"], null, "parcelRequire170a")

//# sourceMappingURL=index.e627dc85.js.map
